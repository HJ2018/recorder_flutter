...
class KColor {
  ...
  static Color NavMainColor = Color.fromARGB(255, 80, 190, 115);
...
//  static const Color app_main = Color(0xFF4688FA);
  ...
  static const Color StartColor = Color(0xFF3BB815); //渐变开始色
  static const Color EndColor = Color(0xFF34CABE); //渐变结束色
...
class weizhiTitle extends StatelessWidget{
  String title;
  String img;

  weizhiTitle(this.title, this.img);
  @override
