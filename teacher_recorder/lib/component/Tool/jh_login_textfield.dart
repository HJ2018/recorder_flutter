...
const TextStyle _hintTextStyle = TextStyle(fontSize: 16.0,color: Color(0xFFBBBBBB));
...
class _JhLoginTextFieldState extends State<JhLoginTextField> {
   ...
   TextStyle _TtextStyle;
   TextStyle _ThintTextStyle;
  ...
  void initState() {
    ...
    _TtextStyle = widget.TtextStyle;
    _ThintTextStyle = widget.hintTextStyle;
