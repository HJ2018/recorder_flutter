...
class DioUtils {
  ...
  static Dio createInstance() {
    ...
    if (_dio == null) {
      ...
      if (AppSettingUtils.getStringWithKey(KEY.TOKEN_KEY).length >0){
        httpHeaders["accessToken"] = AppSettingUtils.getStringWithKey(KEY.TOKEN_KEY);
      }else{
...
/// 自定义Header
 Map<String, dynamic> httpHeaders = {
  ...
  'accessToken': AppSettingUtils.getStringWithKey(KEY.TOKEN_KEY),
  'deviceCode':AppSettingUtils.getStringWithKey(KEY.UDID_KEY),
  'deviceType':APIs.Type(),
  'devicePlatform':'1'
};
