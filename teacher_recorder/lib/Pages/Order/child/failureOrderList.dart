  ...
  Widget _cellItem(){
    ...
    if(groupData.length==0){
      return Container(
        ...
        //    alignment: Alignment.center,
        child:  Text("暂无失败数据...",textAlign: TextAlign.center,style:  TextStyle(fontSize: 17.0,color: Colors.grey)),
      );
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Text("匹配失败",style:  TextStyle(color: Colors.red),),
