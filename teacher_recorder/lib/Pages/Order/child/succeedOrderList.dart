...
class SucceedPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return _SucceedPageState();
  }
}

class _SucceedPageState extends State<SucceedPage> {
  ...
  void getNewData() async{
    ...
    DataUtils.MatchingListData({"page": pageIndex, "pageSize": 10, "state":"1"},
        success: (result) {
          print(result);
  ...
  Widget _cellItem(){
    ...
    if(groupData.length==0){
      return Container(
        ...
        //    alignment: Alignment.center,
        child:  Text("暂无成功数据...",textAlign: TextAlign.center,style:  TextStyle(fontSize: 17.0,color: Colors.grey)),
      );
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Text("匹配成功",style:  TextStyle(color: KColor.NavMainColor),),
